...
EOF;
    ...
    protected function installInertiaStack()
    {
        ...
        (new Filesystem)->ensureDirectoryExists(resource_path('js/JetstreamPlus'));
        (new Filesystem)->ensureDirectoryExists(resource_path('js/Languages'));
        ...
        (new Filesystem)->copyDirectory(__DIR__.'/../../stubs/inertia/resources/js/JetstreamPlus', resource_path('js/JetstreamPlus'));
        (new Filesystem)->copyDirectory(__DIR__.'/../../stubs/inertia/resources/js/Languages', resource_path('js/Languages'));
